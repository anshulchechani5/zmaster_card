		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Card",
									"targetURL": "#zmastercardzmastercard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmastercardzmastercard-display": {
								"semanticObject": "zmastercardzmastercard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmastercard.zmastercard",
									"url": sap.ui.require.toUrl("zmastercard/zmastercard")
								}
							}
						}
					}
